exports.createView = function(board, onclick) {
    function getColor(c) {
        ...
        return c.isTile ? colorSet[c.content % colorSet.length] : "white";
    }
    var boardSize = board.length;
    var pSize = Math.min(Ti.Platform.displayCaps.platformWidth, Ti.Platform.displayCaps.platformHeight);
    var spacer = 10;
